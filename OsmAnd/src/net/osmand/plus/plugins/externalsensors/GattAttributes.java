...
public class GattAttributes {
	...
	// Bike Radar (Garmin Varia RTL-compatible / Bryton Gardia)
	// TODO: Update SERVICE_RADAR and CHAR_RADAR_MEASUREMENT with confirmed Bryton Gardia UUIDs
	//       after BLE sniffing with nRF Connect. Current values match Garmin Varia RTL protocol.
	...
	static {
		...
		SUPPORTED_CHARACTERISTICS.add(UUID.fromString(CHAR_RADAR_MEASUREMENT));
	}
}
